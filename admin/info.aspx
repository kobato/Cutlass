...
<body class="ContentBody">
    <form id="serverInfoForm" runat="server">
    <div class="MainDiv">

<table width="100%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
	<th class="CTitle">服务器配置信息</th>
  </tr>
  <tr>
    <td class="CPanel">
    <div align="left" style="padding:5px;line-height:150%">
     <b>软件版本:</b> <%=Fetch.Version%><br/>
     <b>软件最新更新时间:</b><%=Fetch.BuildDate %><br />
     <b>服务器时间:</b> <%=DateTime.Now%><br/>
     <b>服务器物理路径:</b><%=Request.ServerVariables["APPL_PHYSICAL_PATH"]%><br/>
     <b>站点相对路径:</b><%=Request.ServerVariables["PATH_INFO"]%><br />
     <b>服务器空间占用:</b> <%=Fetch.GetFilesSize(Request.ServerVariables["APPL_PHYSICAL_PATH"]).ToString("###,###")%>Bytes<br/>
     <b>系统内存占用:</b><%= (((double)System.Diagnostics.Process.GetCurrentProcess().WorkingSet64) / 1024) / 1024%>MB<br />
     <b>服务器可以内存:</b><%=this.Context.Cache.EffectivePrivateBytesLimit / 1024 /1024 %>MB<br/>
     <b>Web服务器版本:</b> <%=Request.ServerVariables["SERVER_SOFTWARE"]%> ( .NET RTL 版本: <%=Environment.Version%> )<br/>
     <b>脚本超时设置:</b> <%=Server.ScriptTimeout%> 秒<br/>
     <b>服务器操作系统:</b><%=Environment.OSVersion.ToString()%> <br/>
     <b>服务器运行时长:</b><%=Math.Round((double)(Environment.TickCount/600/60))/100%> 小时<br />
     <b>服务器名:</b><%=Environment.MachineName%><br />
     <b>服务器IP地址:</b> <%=Request.ServerVariables["SERVER_NAME"]%> / <%=Request.ServerVariables["LOCAL_ADDR"]%><br/>
     <b>客户端IP地址:</b> <%=Fetch.UserIp%><br/>
     <b>当前服务器Trust Level:</b><%=Fetch.GetCurrentTrustLevel().ToString() %><br /><br />
     <b>以下信息代码来自<a href="http://code.google.com/p/aspnetsysinfo/downloads/list" target="_blank">aspnetsysinfo</a></b> <br/>
