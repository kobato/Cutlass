...
<%--            <tr>
            ...
            <tr>
              ...
              <td align="left"><input name="url" type="text" class="inputBox" id="url" size="50" maxlength="150"/><span id="urlmessage"></span>
            ...
            <tr id="seo_keywords">
              ...
              <td align="left"><textarea id="keywords" name="keywords" rows="3" cols="60"></textarea>
              </td>
            </tr>
            <tr id="seo_description">
             ...
             <tr>
              ...
              <div>
              <textarea id="content" name="content" rows="12" cols="60"></textarea>
              <script type="text/javascript">
          ...
          <tr>
              ...
              <div id="Div_Intro">
              <textarea id="intro" name="intro" rows="6" cols="60"></textarea>
              <script type="text/javascript">
