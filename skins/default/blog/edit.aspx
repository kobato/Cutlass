...
<script type="text/javascript">
    ...
    function showSeoInfo(isshow) {
        if (isshow == true || isshow == "checked") {
            $("#seo_keywords").slideToggle("fast");
            $("#seo_description").slideToggle("fast");
            $("#seoInfo").text("隐藏");
        } else {
            $("#seo_keywords").hide("fast");
            $("#seo_description").hide("fast");
            $("#seoInfo").text("显示");
        }
    }
</script>
...
<%--            <tr>
            ...
            <tr>
              <td width="72" height="24" align="right" valign="top"><span style="font-weight: bold">EntryName:</span></td>
              <td align="left"><input name="url" type="text" class="inputBox" id="url" size="50" maxlength="150" value="<%=editblog.url %>"/><span id="urlmessage"></span>
              <br />(EntryName即地址别名,可空,只能使用字母、数字、-连字符、_下划线,不超过150个字符)
              </td>
            </tr>
            <tr>
                <td width="72" height="24" align="right" valign="top"><span style="font-weight: bold">SEO选项:</span></td>
              <td align="left"><%=Html.CheckBox("enableSeo", false, new { onclick = "showSeoInfo(this.checked);" })%><label for="enableSeo" id="seoInfo">开启</label>
              </td>
            </tr>
            <tr id="seo_keywords">
              <td width="72" height="24" align="right" valign="top"><span style="font-weight: bold">Meta关键字:</span></td>
              <td align="left"><textarea id="keywords" name="keywords" rows="3" cols="60"><%=editblog.keywords%></textarea>
              </td>
            </tr>
            <tr id="seo_description">
              <td width="72" height="24" align="right" valign="top"><span style="font-weight: bold">Meta简介:</span></td>
              <td align="left"><textarea id="description" name="description" rows="5" cols="60"><%=editblog.description%></textarea>
              </td>
            </tr>
             <tr>
